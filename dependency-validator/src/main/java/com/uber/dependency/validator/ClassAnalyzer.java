...
public class ClassAnalyzer {
   ...
   * @param jar where the missing class is searched (used for reporting purposes)
   ...
   *
   * @param numFound number of missing classes found so far
   ...
   * @return <code>true</code> number of missing classes found so far, inluding
